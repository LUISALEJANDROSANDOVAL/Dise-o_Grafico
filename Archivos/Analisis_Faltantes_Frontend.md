...
- **Landing Page (Onboarding):** Se ha construido una página de inicio con sistema de partículas interactivas, que guía al usuario hacia la herramienta.
- **RF-01, RF-02:** Selección de perfil (Diseñador / Microempresario) desde la Landing Page y en la cabecera.
...
- **RF-23:** Pestaña educativa con la guía rápida de "Cómo elegir un nombre adecuado para tu empresa".
...
*Actualización:* Esta pantalla ya ha sido implementada exitosamente como la Landing Page principal (`/`), junto con la pestaña educativa para elegir nombre (`/elegir-nombre`), cumpliendo con la experiencia de usuario planeada.
